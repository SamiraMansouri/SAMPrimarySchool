...
<body>
	<div class="container-fluid">
		...
		<!-- left menu -->
			...
			<!-- Grade List -->
			<div class="col-md-9">
			<form name="myForm" role="form " action="EditGradeList" method="POST" onsubmit="return validateForm()">
				<h1>Grade List</h1><input type="hidden" name="id" value="${gradeList.id}" />
			...
			<!-- Date -->
				<div style="margin-top: 5%;">
					...
					<div class="input-group input-append date" id="datePicker">
						<input type="text" class="form-control" name="date" value="${gradeList.date }"/> <span
					...
					<div style="margin-top: 5%;">
						<h4>Scale</h4>
						<textarea class="form-control" rows="1" id="scale"
							name="scale" >${gradeList.scale }</textarea>
					</div>
					<!-- Scale -->
					<!-- Description -->
					<div style="margin-top: 5%;">
						<h4> Brief Description</h4>
						<textarea class="form-control" rows="7" id="description" name="description">${gradeList.description }</textarea>
					</div>
					<!-- Description -->
					
					
				<table class="table-bordered table-hover table" style="margin-top: 10%;">
						<thead>
...
<tbody>
							<c:forEach var="grade" items="${grades}">
								<tr>
									...
									<!-- Name -->
									<td><label >${grade.student.firstName}  ${grade.student.lastName} </label></td>
									<!-- Name -->

									<!-- Grade -->
									<td>  <input type="text" class="form-control" name="${grade.student.iD}" value="${grade.value}"></td>
									<!-- Grade -->
									
									<!-- Description -->
									<td>  <input type="text" class="form-control" name="gradeDescription${grade.student.iD} " value=" ${grade.description}"></td>
									<!-- Description -->
