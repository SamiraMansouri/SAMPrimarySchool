...
// 		       window.location = '/samPrimarySchool/deleteAssignment?values='+values;
// 		})
// 	});
...
// 		                   values.push($(this).text());
// 		              });
//         	 window.location = '/samPrimarySchool/showAssignment?id='+values[0];
//         });
//     });
		...
		<div class="row">
			...
			<div class="col-md-9">
				<c:if test="${not empty assignmentsList}">
						...
						<thead>
							...
							<c:forEach var="assignment" items="${assignmentsList }">
								<tr>
									...
									<td>
										<div class="checkbox">
											<label><input class="checkbox" type="checkbox" name="case" id="${assignment.id}"></label>
											</div>
									</td>
									<!-- checkbox -->
					...
					<div>
					<button  type="button" class="btn  btn-danger btn-lg pull-right" id="delete" onclick="return confirmation();"
