...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<!-- dropdownlist -->
			<div class="col-md-9">
		<form role="form " action="EditAssignment.htm" method="POST">
				<h1>Edit Assignment</h1><input type="hidden" name="id" value="${assignment.id }" />
				<c:if test="${message=='success'}">
				<div class="alert alert-success fade in">
				    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
				    <strong>Success!</strong> The assignment edited successfully.
				  </div>
				  </c:if>
			...
			<c:if test="${(message!='success') && (not empty message)}">
				...
				<div style="margin-top: 5%;">
					<h4>Goal</h4>
					<textarea class="form-control" rows="2" id="goal" name="goal">${assignment.goal}</textarea>
				</div>
				<!-- Goal -->
				...
				<div style="margin-top: 5%;">
					...
					<div class="input-group input-append date" id="datePicker">
						<input type="text" class="form-control" name="date" value="${assignment.deadline }"/> <span
					...
					<div style="margin-top: 5%;">
						<h4>Description</h4>
						<textarea class="form-control" rows="7" id="description" name="description">${assignment.content }</textarea>
					</div>
					<!-- Description -->
				</div>
